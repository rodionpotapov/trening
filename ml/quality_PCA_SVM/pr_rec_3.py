...
red = clf.best_estimator_.predict(x_test)  # refit говоит лучшая комбинация гиперов — вот эта, после подбора гиперов обучи ЛУЧШУЮ модель ещё раз на всех данных.
